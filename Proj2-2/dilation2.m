%%%%%%%%%%%%%%%%%%%%%%   Function dilation1   %%%%%%%%%%%%%%%%%%%%%%%%%%%
% Purpose:  
%      implement dilation operation for input X by a structuring element
%
% Input Variables:
...
%             X is origing. 
%      5.  use OR operation to combine all moved image X to output Y
...
Y = Xtemp; % output only the original size of image X
